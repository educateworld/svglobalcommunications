       ...
       <div class="row">
          <div class="col-lg-12 col-md-12"> 
            <div class="title_area">
              <h2 class="title_two">We are SVGlobalCommunications</h2>
              <span></span> 
              <p>Best in TeleCommunications <br></div>
          </div>
       </div>
       <div class="row">
         ...
         <div class="col-lg-4 col-md-4 col-sm-4">
           <div class="contact_address wow fadeInRight">
             ...
             <div class="address_group">
               <p>#17-1-383/55,Ground Floor, IS Sadhan, Champapet, Santhosh Nagar, Hyderabad, TS 500079, India

</p>
               <p>Phone: +91 7338227777</p>
               <p>Email:info@SVGlobalCommunications.com</p>
             </div>
             <div class="address_group">
